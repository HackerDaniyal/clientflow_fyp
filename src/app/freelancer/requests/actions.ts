...
export async function acceptRequest(requestId: string) {
  ...
  if (request.freelancer_id !== user.id) {
    throw new Error('You can only accept requests assigned to you')
  }

  if (!request.client_id) {
    throw new Error('Request is missing client information')
  }
  ...
  // 3. Add freelancer and client as workspace members
  ...
  if (memberError) {
    console.error('Error adding workspace members:', memberError)
  }
